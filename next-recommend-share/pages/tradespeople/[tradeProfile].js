...
import { TradesPeople_Profile_Details, Recommendation_Data } from '../../redux/treadspeople/action'
...
export default function tradespeopleDetails(props) {
    ...
    const { error, tradespeopleData, recommendation } = reState.tradePeople;
    ...
    useEffect(() => {
        ...
        dispatch(Recommendation_Data(tradeData.name))
        setRecommendation_Data(typeof recommendation != 'undefined' ? recommendation : null)

    }, [setTradeData, tradespeopleData.length != 0, setRecommendation_Data, tradeData, recommendation.length != 0])

    console.log("*****", recommendation_data.length)
    return (
        <React.StrictMode>
                                ...
                                <Row>
                                    <div className="three columns alpha">
                                        <ColorBox
                                            ...
                                            value={[
                                                {
                                                    data: recommendation_data.length == 0 ? "0" : recommendation_data.Received_positive
                                                }
                                            ]}
                                            // {recommendation_data.Received_positive}
                                    ...
                                    <div className="three columns">
                                        <ColorBox
                                            ...
                                            value={[
                                                {
                                                    data: recommendation_data.length == 0 ? "0" : recommendation_data.Received_nagative
                                                }
                                            ]}
                                    ...
                                    <div className="three columns">
                                        <ColorBox
                                            ...
                                            value={[
                                                {
                                                    data: recommendation_data.length == 0 ? "0" : recommendation_data.Given_positive
                                                }
                                            ]}
                                            caption='Positive Recommendations'
                                        />
                                    ...
                                    <div className="three columns">
                                        <ColorBox
                                            ...
                                            value={[
                                                {
                                                    data: recommendation_data.length == 0 ? "0" : recommendation_data.Given_nagative
                                                }
                                            ]}
                                            caption='Nagative Recommendations'
                                        />
